...
public class CheckListActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.czterysery.drone.drone.R.layout.checklist_layout);
        ...
        if (connectionManager.isOnline()){
            ...
            String pdf = getString(com.czterysery.drone.drone.R.string.checklist_link);//Link for file
